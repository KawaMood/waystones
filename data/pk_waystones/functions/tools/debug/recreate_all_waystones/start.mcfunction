#> pk_waystones:tools/debug/recreate_all_waystones/start
...
execute if score $pk.waystones.debug.recreate.waystones.length pk.value matches 0 run function pk_waystones:tools/debug/recreate_all_waystones/stop
execute if score $pk.waystones.debug.recreate.waystones.length pk.value matches 1.. run function pk_waystones:tools/debug/recreate_all_waystones/1