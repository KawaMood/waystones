#> pk_waystones:tools/debug/recreate_all_waystones/5
...
execute if score $pk.waystones.debug.recreate.waystones.length pk.value matches 0 as @a[tag=pk.waystones.recreate] run function pk_waystones:tools/debug/recreate_all_waystones/stop
execute unless score $pk.waystones.debug.recreate.waystones.length pk.value matches 0 run function pk_waystones:tools/debug/recreate_all_waystones/1