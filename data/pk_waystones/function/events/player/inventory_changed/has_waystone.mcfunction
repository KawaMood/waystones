...
execute if items entity @s container.* #pk_waystones:placer[custom_data~{pk_data:{id:"waystone",from:"waystones"}},!custom_data~{pk_data:{version:30600s}}] run function pk_waystones:items/waystone/update/run {version:30600s}
