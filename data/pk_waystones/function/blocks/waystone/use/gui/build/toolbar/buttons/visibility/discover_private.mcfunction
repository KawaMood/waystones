...
data modify storage pk:common temp.gui.item set value {id:"minecraft:leather_helmet",count:1,components:{"minecraft:custom_name":[{text:"Visibility: ",italic:false},{text:"Discover (private)",color:"yellow",italic:false}],"minecraft:dyed_color":16701501,"minecraft:attribute_modifiers":[],"minecraft:trim":{material:"minecraft:redstone",pattern:"minecraft:sentry"},"minecraft:bundle_contents":[{id:"minecraft:stick",count:64}],"minecraft:tooltip_display":{hidden_components:["minecraft:dyed_color","minecraft:attribute_modifiers","minecraft:trim"]},"minecraft:custom_data":{pk_data:{gui:1b,from:"waystones",trigger:"visibility/change",trigger_params:{allowed:1b}}},"minecraft:custom_model_data":{strings:["pk_waystones:gui_visibility_discover"]}},Slot:21b}
