...
execute if data storage pk:common temp.used_waystone{visibility:"discover_private"} run function pk_waystones:blocks/waystone/use/gui/build/toolbar/buttons/visibility/discover_private
