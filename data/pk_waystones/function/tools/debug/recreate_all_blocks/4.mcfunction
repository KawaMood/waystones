...
tellraw @a[tag=pk.debug.recreate] [{text: "Recreated \"",color: "gray"},{nbt:"debug.recreate.block_id",storage:"pk:common",interpret:true},{text: "\" at ["},{nbt:"debug.recreate.block.location.x",storage:"pk:common",interpret:true},{text: ","},{nbt:"debug.recreate.block.location.y",storage:"pk:common",interpret:true},{text: ","},{nbt:"debug.recreate.block.location.z",storage:"pk:common",interpret:true},{text: "] in "},{nbt:"debug.recreate.block.location.dimension",storage:"pk:common",interpret:true}]
